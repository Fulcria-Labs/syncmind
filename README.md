...
```bash
# Run all 195 tests (backend + frontend)
npm test

# Backend tests only (93 tests: AI processing, agent tools, data layer, auth, transactions)
cd backend && npm test

# Frontend tests only (102 tests: components, keyword extraction, schema, sync connector)
