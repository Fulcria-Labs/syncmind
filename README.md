...
```bash
# Run all 361 tests (backend + frontend)
npm test

# Backend tests only (143 tests: AI processing, agent tools, data layer, auth, transactions)
cd backend && npm test

# Frontend tests only (218 tests: components, keyword extraction, schema, sync connector)
